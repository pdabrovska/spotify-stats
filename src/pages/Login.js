...
export const Login = () => {
  ...
  const redirect_uri = 'https://ur-music-stats.web.app/';
  ...
  return (
    <motion.div 
      ...
      exit={{opacity: 0}}
    >
      <h1 className='text-3xl font-bold'>MusicStats</h1>
      <p className='text-center max-w-[70vw]'>
        Welcome to MusicStats, your gateway to a personalized music journey through data insights. Explore your top songs and artists on Spotify over 1 year, 6 months, and 4 weeks, tracing the evolution of your music taste from enduring favorites to recent discoveries. Beyond playlists, delve into detailed analyses of Spotify user data and music stream worldwide through PowerBI tables.
      </p>
